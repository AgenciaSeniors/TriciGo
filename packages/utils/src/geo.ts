...
/* The viewport POI overlay (fetchPoisInViewport / ViewportPoi) lived here
 * until #225 removed the cuba_pois layer in favor of Mapbox's own POIs.
 * The `pois_in_viewport` RPC it called still exists server-side. */
