...
**Estado:** 00592 **no aplicada a prod** (MCP guard: autorizar explícitamente); los cambios de app requieren **rebuild de las dos apps**. Mientras tanto, si a un conductor le sale el toast: cerrar la app por completo y reabrirla; si persiste, Perfil → Cerrar sesión → volver a entrar.
