...
**Numeración próxima libre:** verificar antes de cada PR nuevo con `git ls-tree origin/master supabase/migrations/ | awk -F'\t' '{print $2}' | sort -r | head -5` **y también contra los PRs abiertos** (`gh pr view <n> --json files`). Al cierre 2026-08-21 la última en master es **00571**; **00569** y **00572** ya están reservadas por PRs abiertos (#965 y #973). Próxima libre **00573**. Ojo con el hueco: 00569 NO aparece en master y aun así está tomada — mirar solo `origin/master` te haría elegirla.
