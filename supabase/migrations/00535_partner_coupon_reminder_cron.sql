...
COMMENT ON FUNCTION public.notify_expiring_partner_coupons() IS
  '00535 One reminder push per unredeemed coupon with ~30 minutes left. The 25-35 min window against the 5-minute cadence gives at-least-once; reminded_at gives at-most-once. Cron-only: never granted to anon or authenticated.';
