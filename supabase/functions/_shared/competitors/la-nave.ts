// ============================================================
// TriciGo — La Nave adapter (STUB until Phase 0 reconnaissance)
//
...
// capturing La Nave's fare-estimate request from their own Android with their
...
function buildQuoteRequest(route: CompetitorRoute, credential: string): Request | null {
  ...
  //   return new Request('https://<la-nave-host>/<estimate-path>', {
  //     method: 'POST',
...
export const laNaveAdapter: CompetitorAdapter = {
  key: 'la_nave',
