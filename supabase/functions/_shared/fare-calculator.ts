// ============================================================
// TriciGo — Fare Calculator (Edge Function mirror)
//
// DUPLICATE of `packages/utils/src/fareCalculator.ts`. Edge Functions run on
// Deno and don't import the `@tricigo/utils` package (TypeScript/Node). This
// copy lets the competitor-price observatory compute TriciGo's own fare —
// server-side, in the SAME cycle it captures a competitor's quote — using the
// EXACT formula the passenger sees, without re-deriving it.
//
// DO NOT edit one copy without the other. Divergence is caught mechanically by
// supabase/functions/_shared/fare-calculator.test.ts (parity test, run by the
// @tricigo/api vitest project), not by discipline — same spirit as
// check:poi-taxonomy. If that test is red, the two copies drifted.
//
// The file below is byte-for-byte the body of packages/utils/src/fareCalculator.ts.
// ============================================================
