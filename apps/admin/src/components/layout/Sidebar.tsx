...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/code-performance', labelKey: 'sidebar.code_performance', defaultLabel: 'Rendimiento', icon: Gauge },
      ...
      { href: '/competitors', labelKey: 'sidebar.competitors', defaultLabel: 'Competencia', icon: Radar },
