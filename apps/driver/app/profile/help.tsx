...
const CATEGORIES: { value: TicketCategory; label: string }[] = [
  ...
  { value: 'passenger_complaint', label: 'Queja de pasajero' },
          ...
          ListHeaderComponent={
            <View>
              ...
              <Card variant="filled" padding="md" className="mt-1 mb-6 bg-neutral-800">
                <Text variant="body" color="inverse" className="font-semibold mb-2">Contacto</Text>
              ...
              {/* Tickets header */}
              {tickets.length > 0 && (
                <Text variant="h4" color="inverse" className="mb-3">Mis tickets</Text>
              )}
            </View>
          }
          ListEmptyComponent={
