...
const CONFIG_KEY = 'driver_latest_version';
const ANDROID_PACKAGE = 'app.tricigo.driver';
const IOS_APP_ID = '6785157051';
...
/**
 * "Update available" bottom sheet (driver copy of the rider component). On
 * app open, compares the installed version against the latest store version
 * in platform_config; when outdated, offers a one-tap jump to Play Store /
 * App Store. Dismissible — reappears on the next cold start until the driver
 * updates. Silent when the config key is missing or the network fails.
 */
