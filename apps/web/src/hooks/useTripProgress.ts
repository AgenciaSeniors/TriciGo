...
/**
 * Web port of the mobile client's `useTripProgress` (apps/client/src/hooks).
 * Calculates trip progress by projecting the driver's current position onto
 * the route polyline. Progress is monotonic (never decreases).
 *
