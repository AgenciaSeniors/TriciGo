 ...
 * `center` so we can preview how markers render before there are real
 * drivers online. Returns `[]` when disabled. Gated to dev/demo builds
 * by the caller — never shown to real users in production.
 */
