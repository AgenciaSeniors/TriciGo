...
// the wallet route → expo-router's fromImport, crashing the TriciCoin tab on open
// (Apple rejection 2.1(a), client build 16). Falling back to a no-proxy stub keeps
// the route loadable; useNetopiaCheckout then takes its existing WebBrowser path.
