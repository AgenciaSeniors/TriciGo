    ...
    <Screen bg="white" padded>
      ...
      >
        ...
        {/* Compact balance card — bg.elev1 surface with line border instead
            of the heavy orange hero gradient. Numbers in BalanceBadge stay
            big (it's the primary metric of this screen) but the surface is
            calmer and matches the home's card aesthetic. */}
