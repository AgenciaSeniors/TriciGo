...
const FAQ_ITEMS = [
  ...
  { qKey: 'support.faq_q2', aKey: 'support.faq_a2', defaultQ: '¿Cómo compro créditos de viaje?', defaultA: 'Ve a la sección Créditos, selecciona "Comprar créditos" e ingresa el monto deseado.' },
